		...
		return (<div className="container">
			...
			<h3>Productos</h3>
				<table className="rwd-table table-striped table-hover snow">
					...
					<tbody>
						{
							this.state.obras.productos.length && this.state.obras.productos.map(product=>{
								return (<tr>
									...
									<td data-th="Acción" className="text-center">
										<button className="btn btn-danger btn-xs but" type="button" data-toggle="modal" data-target={"#deleteProductModal-" + product.producto._id}>
												...
												<div className="modal-content">
													...
													<div className="modal-body">
														<div>
															...
															<br/>- {product.producto.descripcion}</p>
														</div>
														<div className="row">
			...
			<div className="botspace">
				<p className="snow pull-right">Total: <strong className="big">{Number(this.state.totalPrizeInObra).toFixed(2)} €</strong></p>
			</div>
		</div>)
	}
}
